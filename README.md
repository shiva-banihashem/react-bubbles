...
Web servers are  programs that run on computers to have ability to interact with other computers using certain networking methods. Web servers are interconnected with each other and rest of the internet.
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.
CRUD stands for Create, Read, Update and Delete and respective HTTP methods are POST, GET, PUT and DELETE methods.
